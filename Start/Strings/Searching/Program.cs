...
// Console.WriteLine($"Starts with the: {teststr.StartsWith("the")}");
// Console.WriteLine($"Starts with the (ignore case): {teststr.StartsWith("the", StringComparison.CurrentCultureIgnoreCase)}");
// Console.WriteLine($"Ends with dog: {teststr.EndsWith("dog")}");
// Console.WriteLine($"Ends with dog (ignore case): {teststr.EndsWith("dog", StringComparison.CurrentCultureIgnoreCase)}");
